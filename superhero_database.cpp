...
void loadSuperherodata()
{
    ...
    name[3] ="Matter-Eater"; power[3]= "   | Can Eat Anything"; weakness[3] = "       | Stomach Aches"; yearUni[3][0] = "        | 1962"; yearUni[3][1] = "   |    DC";
...
void sortbyletter()
{
    for (int i=0; i < arraySize - 1; i++)
    {
        ...
        temp = weakness[i];
        weakness[i] = weakness[min];
        weakness[min] = temp;

        temp = yearUni[i][0];
        yearUni[i][0] = yearUni[min][0];
        yearUni[min][0]= temp;

        temp = yearUni[i][1];
        yearUni[i][1] = yearUni[min][1];
        yearUni[min][1] = temp;
    }

    cout << "super heros sorted! ";
    cout << "\nName            | Superpower              |   Weakness            | Year    |  Universe" << endl;
    cout << "-------------------------------------------------------------------------------------------" << endl;
    for (int i = 0; i < arraySize; i++)
    {
